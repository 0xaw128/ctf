...
describe('[Challenge] Truster', function () {
    ...
    it('Exploit', async function () {
        ...
        const ExploitTruster = await ethers.getContractFactory('ExploitTruster', attacker);
        /* pool and DVT address in args */
        const exploitContract = await ExploitTruster.deploy(this.pool.address, this.token.address);
